# README
# descriptions of contents of data/, scripts/ and figures/
...
The following data files are included:
  ...
  - output_het_993734.data:
    note: file too big for Github, please request or generate yourself!
  ...
  - theta312774.data:
    note: not provided because too big for Github, please request or generate yourself
...
# scripts/
All scripts include relative pathways and should be run from within the scripts/ folder, i.e. set the directory to use R command “setwd(“scripts/”)”.
...
# figures/
The following figures can be generated with the provided code in scripts/:

  - Fig2.tiff:
    generated by: scripts/s_exp-fit_p_fig2.R
    description: plot with surveillance data and fitted logistic growth functions

  - Fig3.tiff:
    generated by: scripts/p_fig3.R
    description: prior and posterior distributions of parameters sexual mixing coefficient, fraction of diagnosed and treated infections, average duration of infection, transmission probability within low activity group, transmission probability within high activity group for heterosexual men and women and men who have sex with men

  - Fig4.tiff:
    generated by: scripts/p_fig4.R
    description: plot timeline of proportion resistant infections

  - Fig5.tiff:
    generated by: scripts/p_fig5.R
    description: plot distributions of treatment rates for heterosexual men and women and men who have sex with men

  - S1fig.tiff:
    generated by: scripts/p_Sfigs.R
    description: prevalences and incidences for men who have sex with men

  - S2fig.tiff:
    generated by: scripts/p_Sfigs.R
    description: prevalences and incidences for heterosexual men and women
